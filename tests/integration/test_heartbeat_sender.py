...
# =================================================================================================
def stop(
    heartbeat_sender_controller: worker_controller.WorkerController,  # Add any necessary arguments
) -> None:
    """
    Stop the workers.
    """
    heartbeat_sender_controller.request_exit()
...
def main() -> int:
    ...
    heartbeat_sender_controller = worker_controller.WorkerController()
